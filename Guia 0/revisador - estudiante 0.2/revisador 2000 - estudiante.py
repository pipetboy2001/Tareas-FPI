...
'IndexError':"    Acceso a posiciones inexistentes en una colección (Listas, Strings).\n    Ejemplo:\nacceder al quiento elemento de una lista que solo tiene 2 elementos.",
'TypeError': "    Uso de una operación con un tipo de dato incompatible.    Ejemplo:\n    5 + 'a' ",
'NameError':"    Uso de elementos que no se encuentran definidos previamente en el código.\n    Ejemplo:\n    Usar la variable hola antes de definirla.",
'ValueError' : "    Se ha utilizado un valor inesperado para la operación.\n    Ejemplo:\n    Transformar una palabra en un número int('ABC') ",
...
'SyntaxError' : "    El código no está utilisando correctamente la escritura utilizada en Python\n    Ejemplo:\n    (25 * 3) +  8)\n    (falta/sobra un paréntesis)",
...
'Completado con éxito.': "    Test superado con éxito."
}                
...
for alumno in alumnos:
        ...
        while i < len(testE):
            ...
            if error:
                ...
                if resultado == salida_esperada:
                    ...
                    correctas +=1
                    info_test.append("Completado con éxito.")
    ...
    for e in range(len(info_test)):
        if info_test[e] == "Completado con éxito.":
            print("Test "+str(e+1)+": "+info_test[e])
        else :
